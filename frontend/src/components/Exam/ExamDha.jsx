    ...
    return (
        <div className="exam-wrapper">
            {examFinished ? (
                ...
                <li>
                    الإختبار عبارة عن 150 سؤال في زمن ثلاث ساعات إلا ربع و لا يمكن إيقاف الوقت او اخذ استراحة بمجرد بدء الإختبار
                </li>
                <li>
